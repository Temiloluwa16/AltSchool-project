...
sudo mysql -uroot -e "CREATE DATABASE laura2024;"
sudo mysql -uroot -e "CREATE USER 'laura'@'localhost' IDENTIFIED BY 'laura16';"
sudo mysql -uroot -e "GRANT ALL PRIVILEGES ON laura2024.* TO 'laura'@'localhost';"
cd /var/www/laravel
...
sudo sed -i '25 s/=laravel/=laura2024/' /var/www/laravel/.env
sudo sed -i '26 s/=root/=laura/' /var/www/laravel/.env
sudo sed -i '27 s/=/=laura16/' /var/www/laravel/.env
