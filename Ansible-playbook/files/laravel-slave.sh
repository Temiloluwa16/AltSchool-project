...
sudo sed -i 's/DB_DATABASE=laravel/DB_DATABASE=laura/' /var/www/html/laravel/.env

sudo sed -i 's/DB_USERNAME=root/DB_USERNAME=laura/' /var/www/html/laravel/.env

sudo sed -i 's/DB_PASSWORD=/DB_PASSWORD=laura/' /var/www/html/laravel/.env
